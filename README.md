...
* [`src/cljs/lipase/`](src/cljs/lipase/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/lipase/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `lipase` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/lipase/config.cljs) defaults to `true` in
...
```clj
(ns lipase.example
  (:require [lipase.config :as config])
